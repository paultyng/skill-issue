...
- **Always use the project's tooling** to create the file — `task changelog:new`, `chlg new`, `changie new`, or whatever the project provides. Never hand-author changelog YAML/Markdown directly; the tool sets timestamps, IDs, and required fields that hand-authoring gets wrong.

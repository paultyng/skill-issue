...
- **Don't reference the current task / fix / PR / callers.** "Used by FooBar", "added for #123", "see commit X", since those rot as the codebase evolves and belong in the PR description, not in the source.
